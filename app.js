...
app.get("/", (req, res) => {
    res.render("index"); // Renderiza la vista index.ejs directamente en la raíz
});

// (Opcional) Redirección desde /prueba a la raíz
app.get("/prueba", (req, res) => {
    res.redirect("/"); // Redirige automáticamente a "/"
});
